### Basics
`echo -n Password | md5sum` or sha256sum
Outputs the phrase

### Dictionary Attacks
Using wordlist such as `rockyou.txt` or others.

# Cracking
### John the Ripper
Imagine you come across the passwd file and find this
```bash
r0lf:$6$ues25dIanlctrWxg$nZHVz2z4kCy1760Ee28M1xtHdGoy0C2cYzZ8l2sVa1kIa8K9gAcdBP.GI6ng/qA4oaMrgElZ1Cb9OeXO4Fvy3/:0:0:Rolf Sebastian:/home/r0lf:/bin/bash
``` 
Using a command such as `john --single passwd`
Is able to crack one password at a time

Now using wordlists, one is able to load hashes into a file and go down the list
`john --wordlist=<wordlist_file> <hash_file>`

#### John and hash formats
Running a command of `hashid -j theHash` will indentify what type of hash has been loaded

| Hash                 | Example command                                   | Description                                                          |
| -------------------- | ------------------------------------------------- | -------------------------------------------------------------------- |
